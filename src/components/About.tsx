...
import QuantitativeModelingSuite from './QuantitativeModelingSuite';
// @ts-ignore
        ...
        <AnimatePresence>
          {selectedImage && (
            ...
            >
              ...
              {selectedImage.title === "Quantitative Modeling & Forecasting" ? (
                <motion.div
                  ...
                  className="max-w-5xl w-full bg-editorial-bg border border-editorial rounded-none overflow-hidden cursor-default"
                >
                  <QuantitativeModelingSuite />
                </motion.div>
              ) : (
                <motion.div
                  initial={{ scale: 0.95, opacity: 0 }}
